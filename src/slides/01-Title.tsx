    ...
    <div className="h-full w-full flex items-center justify-center px-4">
      ...
      >
        <motion.div variants={fadeUp} className="mb-8">
          <Badge tone="cyan">Project Proposal · 2025 / 2026</Badge>
        </motion.div>
        ...
        >
          <span className="block text-ink-primary">Course Registration</span>
          <span className="block text-gradient-cyan">Management System</span>
        </motion.h1>
        ...
        >
          A modern web platform that automates course registration, approvals, and scheduling at the Libyan International Medical University.
        </motion.p>
