...
// All non-wireframe slides reuse the /fr deck's slides — only the
// wireframe rendering differs between /fr and /fr2.
...
import { WireframeSlideDark } from './slides/WireframeSlideDark';
...
const wireframeSlides = wireframes.map((w, i) => ({
  key: `wf2-${w.component}`,
  el: <WireframeSlideDark wireframe={w} index={i + 1} total={wireframes.length} />,
}));
