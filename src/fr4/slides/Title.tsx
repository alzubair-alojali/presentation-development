    ...
    <div className="h-full w-full flex items-center justify-center px-4">
      ...
      >
        <motion.div variants={fadeUp} className="mb-8">
          <Badge tone="warm">Document Three · System Design</Badge>
        </motion.div>
        ...
        >
          <span className="block text-ink-primary">System Design</span>
          <span className="block text-gradient-cyan">Diagrams</span>
        </motion.h1>
        ...
        >
          Class diagram, activity diagrams, sequence diagrams, and the
          database schema for the Course Registration Management System —
          re-rendered in the deck's design language.
        </motion.p>
