    ...
    <div className="h-full w-full flex items-center justify-center px-4">
      ...
      >
        <motion.div variants={fadeUp} className="mb-8">
          <Badge tone="violet">Document Two · 2025 / 2026</Badge>
        </motion.div>
        ...
        >
          <span className="block text-ink-primary">Functional Requirements</span>
          <span className="block text-gradient-cyan">&amp; Wireframes</span>
        </motion.h1>
        ...
        >
          What the Course Registration Management System must do, and what each
          screen looks like — for the Libyan International Medical University.
        </motion.p>
