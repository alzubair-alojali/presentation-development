...
export const screens: Screen[] = [
  ...
  { name: 'Student Dashboard', description: 'Shortcuts to Catalog, Schedule, Requests, Notifications.', group: 'student' },
  { name: 'Course Catalog', description: 'All courses with eligibility badges, search and filters.', group: 'student' },
  ...
  { name: 'Cart Sidebar', description: 'Items, conflict warnings, Submit Request button.', group: 'student' },
